...
kubectl create configmap chaincode --from-file=../chaincode/fabcar
kubectl label configmap chaincode app=tracelabel
...
if [ $? -eq 1 ]; then
   ...
   kubectl create secret generic ${RES_NAME}   \
                                            ...
                                            --from-file=sign_key=../crypto-config/peerOrganizations/${BRAND_SHORT}.com/peers/peer0.${BRAND_SHORT}.com/msp/keystore/${PEER_PRIVATE_KEY} \
